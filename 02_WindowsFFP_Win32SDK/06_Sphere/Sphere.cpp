 ...
 *                                                          *
 *                                                          *
 * Description :=>      This program diplays the Sphere.    *
 *                                                          *
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	*********************************************************/
    hwnd = CreateWindowEx( WS_EX_APPWINDOW,                                     // The screen should be above of taskbar
        ...
        TEXT("Sphere : Shruti Tiwarkar"),                            // Tittle of Wiondow 
...
void Display(void) {
    ...
    void RenderIcosahron_SAT(int div_SAT);
...
void RenderIcosahron_SAT(int div) {

    void SubDivide_SAT(float *vec1_SAT, float *vec2_SAT, float *vec3_SAT, int depth_SAT);
    ...
    for(i_SAT = 0; i_SAT < 20; i_SAT++){
        SubDivide_SAT(
            &vdata_SAT[tindices[i_SAT][0]][0],
            &vdata_SAT[tindices[i_SAT][1]][0],
            &vdata_SAT[tindices[i_SAT][2]][0],
            div
        );
    }
}

void SubDivide_SAT(float *vec1, float *vec2, float *vec3, int depth) {

    void Normalize(float vector[]);
    void DrawTriangle(float *vec1, float *vec2, float *vec3);

    GLfloat vect12_SAT[3], vect23_SAT[3], vect31_SAT[3];
    int i_SAT;
    ...
    for(i_SAT = 0; i_SAT < 3; i_SAT++){

        vect12_SAT[i_SAT] = (vec1[i_SAT] + vec2[i_SAT]) /2.0f;
        vect23_SAT[i_SAT] = (vec2[i_SAT] + vec3[i_SAT]) /2.0f;
        vect31_SAT[i_SAT] = (vec3[i_SAT] + vec1[i_SAT]) /2.0f;
    }

    Normalize(vect12_SAT);
    Normalize(vect23_SAT);
    Normalize(vect31_SAT);

    SubDivide_SAT(vec1, vect12_SAT, vect31_SAT, depth - 1);
    SubDivide_SAT(vec2, vect23_SAT, vect12_SAT, depth - 1);
    SubDivide_SAT(vec3, vect31_SAT, vect23_SAT, depth - 1);
    SubDivide_SAT(vect12_SAT, vect23_SAT, vect31_SAT, depth - 1);
